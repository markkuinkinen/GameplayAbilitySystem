...
// asset manager created to load primary assets and initialise gameplaytagsmanager singleton
...
void FAuraGameplayTags::InitialiseNativeGameplayTags()
{
	...
	GameplayTags.Attributes_Secondary_MaxHP = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Attributes.Secondary.MaxHP"), FString("Health cap"));
	GameplayTags.Attributes_Secondary_MaxMana = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Attributes.Secondary.MaxMana"), FString("Mana cap"));
	...
	GameplayTags.Attributes_Secondary_BlockChance = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Attributes.Secondary.CriticalHitChance"), FString("Chance to double damage plus critical hit bonus"));
